...
# Allow pulling secrets from Secrets Manager (DB credentials, etc.)
...
# ─────────────────────────────────────────────
# ECS Task Role
# Permissions the application container itself needs at runtime
# ─────────────────────────────────────────────
...
# Allow ECS Exec for debugging (connect into running containers)
